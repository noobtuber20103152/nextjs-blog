        ...
        <Head>
            ...
            <div className="flex bg-white lg:flex-row  flex-col h-96 container mx-auto lg:justify-start justify-center">
                    ...
                    <div>
                        ...
                        <div className="flex justify-center lg:justify-start mt-6">
                            <Link href="/Blogs/Blog" >
                                <a className="px-3 py-2 mx-4 lg:px-4 lg:py-3 bg-gray-300 text-gray-900 text-xs font-semibold rounded  hover:bg-gray-400 " >
                                    Explore blogs
                                </a>
                            </Link>
                        </div>
                ...
                <div className="lg:block w-1/2" style={{ clipPath: "polygon(10% 0px, 100% 0%, 100% 100%, 0px 100%)" }}>
                    <div className="h-full object-contain" style={{ backgroundImage: "url('https://wallpapercave.com/dwp1x/wp1828900.png')" }}>
