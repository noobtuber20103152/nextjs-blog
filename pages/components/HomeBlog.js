    ...
    return (
        <>
            ...
            <div class="flex flex-wrap justify-around my-3 py-3">
                {data.map((e) => {
                    return <HomeBlogComponent imgLink={Object.values(e)[0].imgLink} author={Object.values(e)[0].author} link={Object.values(e)[0].link} tag={Object.values(e)[0].tag} date={Object.values(e)[0].date} desc={Object.values(e)[0].desc} title={Object.values(e)[0].title} />
                })}
            </div>
        </>
    )
