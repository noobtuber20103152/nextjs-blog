        ...
        <>
            <div className="container flex justify-center my-2">
                <div className="container px-5 justify-start   xl:w-4/6 ">
                    ...
                    <p className='my-1 text-xl'>React is a JavaScript based library which is used to make awesome fronted single page web application. In this blogpost we will share React JS cheat sheet with you. I hope you love it.
                    </p>
                    <p className='my-1 text-xl'>If you love this cheat sheet please fill up feedback form which is motivate me to make such type of cheat sheets 😊.</p>
                    <BigHeading heading="React JS - A JavaScript library" />
                    {data.map((e) => {
                        return (
                            <>
